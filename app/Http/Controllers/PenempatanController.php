...
class PenempatanController extends Controller
{
    ...
    {
        $penempatans = Penempatan::with(['mahasiswa.user', 'sekolah', 'guruPamong.user', 'dosenPembimbing'])
            ->latest()
            ->paginate(10);
    ...
    public function create()
    {
        ...
        return view('admin.penempatan.create', compact('mahasiswas', 'sekolahs', 'guruPamongs', 'dosenPembimbings'));
    }
    ...
    public function edit(Penempatan $penempatan)
    {
        ...
        return view('admin.penempatan.edit', compact('penempatan', 'mahasiswas', 'sekolahs', 'guruPamongs', 'dosenPembimbings'));
    }
