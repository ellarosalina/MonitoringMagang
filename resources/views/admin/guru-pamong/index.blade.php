<x-layouts.admin title="Data Guru Pamong" subtitle="Kelola akun dan data guru pamong">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('admin.guru-pamong.create') }}"
        ...
        <div class="flex items-center gap-2">
            ...
            <form action="{{ route('admin.guru-pamong.index') }}" method="GET">
                ...
                @forelse ($guruPamongs as $guruPamong)
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3 text-sm">
                            {{ $loop->iteration + ($guruPamongs->currentPage() - 1) * $guruPamongs->perPage() }}
                        </td>
                        ...
                        <td class="p-3 text-sm">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a
                                    href="{{ route('admin.guru-pamong.edit', $guruPamong->id) }}"
                                    title="Edit"
                                ...
                                <form
                                    action="{{ route('admin.guru-pamong.destroy', $guruPamong->id) }}"
                                    method="POST"
                                    class="inline"
        ...
        <div class="mt-4 flex justify-end">
            ...
            <div class="flex items-center gap-1">
                ...
                @else
                    ...
                    <a
                        href="{{ $guruPamongs->previousPageUrl() }}"
