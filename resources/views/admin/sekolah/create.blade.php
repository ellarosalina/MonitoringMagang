<x-layouts.admin title="Tambah Sekolah" subtitle="Tambahkan sekolah mitra baru">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl">
        <form action="{{ route('admin.sekolah.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_sekolah" value="{{ old('nama_sekolah') }}" class="w-full border rounded p-2">
            </div>
